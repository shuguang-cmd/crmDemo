...
public class Customer {
    ...
    public String getDswj() {
        return dswj;
    }

    public void setDswj(String dswj) {
        this.dswj = dswj == null ? null : dswj.trim();
    }
    ...
    public void setGswj(String gswj) {
        this.gswj = gswj == null ? null : gswj.trim();
    }
